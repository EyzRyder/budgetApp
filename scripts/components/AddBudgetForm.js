      ...
      <div class="form-wrapper">
        ...
        <form class="grid-sm" id="${id}">
          <div class="grid-xs">
            ...
            <input type="text" id="newBudget" name="newBudget" placeholder="e.g., Groceries" required />
          </div>
          <div class="grid-xs">
            <label for="newBudgetAmount">Amount</label>
            <input type="number" id="newBudgetAmount" name="newBudgetAmount" step="0.01" placeholder="e.g., $350" required inputmode="decimal" />
          </div>
